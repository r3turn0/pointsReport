...
const cca = new ConfidentialClientApplication({
  auth: {
    ...
    authority: `https://login.microsoftonline.com/${process.env.TENANTID}/oauth2/v2.0/token`,
    ...
    try {
        return new Promise(async (resolve, reject) => {
            ...
            if (userUpn === "me") {
                ...
                endpoint = folderPath
                    ? `/users/${userUpn}/drive/root:/${folderPath}:/children`
                    : `/users/${userUpn}/drive/root/children`;
            }
